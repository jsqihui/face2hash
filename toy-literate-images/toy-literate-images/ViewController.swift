...
class ViewController: UIViewController {
    ...
    private func postFaceRepresentation(url: String){
        // prepare json data
        //TODO replace with facevector latter
        let json: [String: Any] = ["device_id": "ABC",
                                   "face2hash": ["1":"First", "2":"Second"]]
    ...
    override func viewDidLoad() {
        ...
        // self.getPhotos()
        self.postFaceRepresentation(url: "http://localhost:8080/hash/")
